...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user == null) {
            ...
            // Set Path để cookie có hiệu lực toàn site
            c_user.setPath("/");
            c_pass.setPath("/");
            c_rem.setPath("/");
