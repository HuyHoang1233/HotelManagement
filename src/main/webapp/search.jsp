                ...
                <div class="col-lg-3 col-md-4 mb-4">
                    <div class="card shadow-sm border-0 sticky-top" style="top: 20px; border-radius: 12px;">
                        <div class="card-body p-4">
                            ...
                            <form id="filterForm" method="GET" action="<%=ctx%>/search">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-6">
                                            <input type="number" class="form-control form-control-sm" name="priceMin" placeholder="Từ..." min="0" value="${priceMin}">
                                        </div>
                                        <div class="col-6">
                                            <input type="number" class="form-control form-control-sm" name="priceMax" placeholder="Đến..." min="0" value="${priceMax}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="amenities" value="wifi" id="amWifi" checked>
                                        <label class="form-check-label" for="amWifi"><i class="fas fa-wifi text-muted me-2"></i>WiFi Miễn Phí</label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="amenities" value="aircon" id="amAir" checked>
                                        <label class="form-check-label" for="amAir"><i class="fas fa-snowflake text-muted me-2"></i>Điều Hòa</label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="amenities" value="tv" id="amTV" checked>
                    ...
                    <div class="row g-4">
                        <c:if test="${empty rooms}">
                            <div class="col-12 text-center py-5 bg-white rounded shadow-sm">
                                ...
                                <p class="text-secondary">Vui lòng thử thay đổi khoảng giá tiền (Ví dụ: Từ 500000 đến 5000000) hoặc đổi ngày nhận/trả phòng!</p>
                            </div>
                        </c:if>
                                ...
                                <div class="card room-card h-100 shadow-sm">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <span class="text-warning small"><i class="fas fa-star"></i> 5</span>
                                        </div>
                                        <h5 class="card-title fw-bold text-dark mb-3">Phòng ${room.roomNumber}</h5>
                                        <ul class="list-unstyled text-muted small mb-3">
                                            <li class="mb-1"><i class="fas fa-user-friends me-2 text-primary"></i>Tối đa 2 khách</li>
                                            <li class="mb-1"><i class="fas fa-vector-square me-2 text-primary"></i>Diện tích: 30m²</li>
                                        </ul>
                                        <div class="mt-auto">
