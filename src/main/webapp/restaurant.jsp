    ...
    <head>
        ...
        <style>
            ...
            .banner-content {
                ...
                color: white;
                text-align: center;
                z-index: 1; /* Added to keep text above the dark overlay */
            }
        ...
        <section class="section">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <img class="img-fluid rounded" src="https://images.unsplash.com/photo-1555396273-367ea4eb4db5" alt="Restaurant Intro">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-md-4">
                        <div class="card food-card">
                            <img src="https://images.unsplash.com/photo-1544025162-d76694265947" class="card-img-top" alt="Beef Steak">
                            <div class="card-body">
                                <h5>Beef Steak</h5>
                    ...
                    <div class="col-md-4">
                        <div class="card food-card">
                            <img src="https://images.unsplash.com/photo-1555939594-58d7cb561ad1" class="card-img-top" alt="Seafood">
                            <div class="card-body">
                                <h5>Seafood</h5>
                    ...
                    <div class="col-md-4">
                        <div class="card food-card">
                            <img src="https://images.unsplash.com/photo-1600891964599-f61ba0e24092" class="card-img-top" alt="Signature Dish">
                            <div class="card-body">
        ...
        <section class="section">
            <div class="container">
                ...
                <div class="row g-4 gallery">
                    <div class="col-md-4">
                        <img src="https://images.unsplash.com/photo-1517248135467-4c7edcad34c4" alt="Gallery 1">
                    </div>
                    <div class="col-md-4">
                        <img src="https://images.unsplash.com/photo-1466978913421-dad2ebd01d17" alt="Gallery 2">
                    </div>
                    <div class="col-md-4">
                        <img src="https://images.unsplash.com/photo-1552566626-52f8b828add9" alt="Gallery 3">
                    </div>
                </div>
            </div>
        </section>
