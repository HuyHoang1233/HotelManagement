    ...
    <head>
        ...
        <style>
            ...
            .register-container {
                background: #ffffff;
                width: 100%;
                max-width: 600px; /* Rộng hơn login một chút */
                padding: 40px;
            ...
            .btn-marriott:hover {
                background-color: #b31b1b; /* Màu đỏ Marriott */
            }
        ...
        <div class="register-container">
            ...
            <form action="register" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating mb-3">
                            <input type="password" class="form-control" name="repassword" placeholder="Confirm" required>
                ...
                <button type="submit" class="btn btn-marriott">Join Now</button>
            </form>
